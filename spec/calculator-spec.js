...
describe('Calculator', function(){
  it('should test whether calculator has created new calculator instance', function(){
    let userAge = new Calculator(25, "United States");
    expect(userAge.age).toEqual(25);
    expect(userAge.lifeExp).toEqual("United States");
  });
  ...
  it('should test whether calculator has check if you have surpassed the average life expectancy on each planet', function(){
    let userAge = new Calculator(25, "United States");
    expect(userAge.convert().checkLifeExp()).toEqual(["Surpassed life expectancy","Still below life expectancy","Still below life expectancy","Still below life expectancy"]);
  })
});
